...
console.log("Connecting IMALKA-MD...✅");
...
console.log('IMALKA-MD connected to whatsapp ✅')

let up = `*CHALAH-MD CONNECTED*

> _.Menu = Get Bot All Commands_ ⤵

> _.Settings = Customize Bot Settings Work For Owner Only._❄️

OWN BY CHALANA INDUWARA

https://wa.me/94776938009`;
...
app.get("/", (req, res) => {
res.send("IMALKA-MD BOT started✅");
});
